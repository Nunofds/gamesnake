window.onload = function () {
    ...
    function Snake(body, direction) {
        ...
        this.ateApple = false;
        this.draw = function () {
            //methode pour dessiner le corps du serpent dans le canvas (écran)
            ctx.save();
        ...
        this.advance = function () {
            //methode pour faire avancer le serpent
        ...
        this.checkCollission = function () {
            //méthode pour vérifier collissions du serpent (mur,corps)
        ...
        this.isEatingApple = function (appleeToEat) {
            //methode pour savoir si serpent a mangé la pomme
            var head = this.body[0];
            if (
                head[0] === appleeToEat.position[0] &&
                head[1] === appleeToEat.position[1]
            ) {
                return true;
            } else {
                return false;
